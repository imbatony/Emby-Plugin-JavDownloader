// -----------------------------------------------------------------------
// <copyright file="JavWebProxy.cs" author="imbatony">
...
namespace MediaBrowser.Plugins.JavDownloader.Http
{
    ...
    public class JavWebProxy : IWebProxy
    {
        ...
        /// 代理服务.
        /// </summary>
        public IWebProxy Proxy { get => proxy ?? WebRequest.DefaultWebProxy; set => proxy = value; }

        /// <summary>
        /// Gets or sets the Credentials
        /// The credentials to submit to the proxy server for authentication..
        /// </summary>
        public ICredentials Credentials { get => Proxy.Credentials; set => Proxy.Credentials = value; }

        /// <summary>
        /// Initializes a new instance of the <see cref="JavWebProxy"/> class.
        /// </summary>
        public JavWebProxy()
        {
            Reset();
