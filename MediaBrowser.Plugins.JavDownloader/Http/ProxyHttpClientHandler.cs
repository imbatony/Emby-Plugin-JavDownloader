// -----------------------------------------------------------------------
// <copyright file="ProxyHttpClientHandler.cs" author="imbatony">
...
namespace MediaBrowser.Plugins.JavDownloader.Http
{
    ...
    public class ProxyHttpClientHandler : HttpClientHandler
    {
            ...
            HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (request.RequestUri.ToString().Contains("javstream.top/api/source") && request.Method == HttpMethod.Post)
            {
                request.Headers.Add("referer", "https://javstream.top");
            }
